...
// Lazy load the DiscoverView component
const DiscoverView = dynamic(() => import("./discover-view").then(mod => ({ default: mod.DiscoverView })), {
  loading: () => (
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 pb-20 relative overflow-hidden">
      ...
      <div className="bg-white/10 backdrop-blur-xl border-b border-white/20 px-4 py-3 relative z-10">
        <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Discover</h1>
      </div>
